...
var require_streams = __commonJS({
  "node_modules/fetch-blob/streams.cjs"() {
    ...
    if (!globalThis.ReadableStream) {
      try {
        const process2 = __nccwpck_require__(765);
    ...
    try {
      const { Blob: Blob3 } = __nccwpck_require__(293);
...
var init_from = __esm({
  "node_modules/fetch-blob/from.js"() {
    import_node_fs = __toModule(__nccwpck_require__(747));
    import_node_path = __toModule(__nccwpck_require__(622));
    import_node_worker_threads = __toModule(__nccwpck_require__(13));
    init_file();
    init_fetch_blob();
...
var import_node_http2 = __toModule(__nccwpck_require__(605));
var import_node_https = __toModule(__nccwpck_require__(211));
var import_node_zlib = __toModule(__nccwpck_require__(761));
var import_node_stream2 = __toModule(__nccwpck_require__(413));
...
var import_node_stream = __toModule(__nccwpck_require__(413));
var import_node_util = __toModule(__nccwpck_require__(669));
init_fetch_blob();
init_esm_min();
...
var import_node_util2 = __toModule(__nccwpck_require__(669));
var import_node_http = __toModule(__nccwpck_require__(605));
...
var import_node_url = __toModule(__nccwpck_require__(835));
...
var import_net = __toModule(__nccwpck_require__(631));
...
var net = __nccwpck_require__(631)
  , tls = __nccwpck_require__(16)
  , http = __nccwpck_require__(605)
  , https = __nccwpck_require__(211)
  , events = __nccwpck_require__(614)
  , assert = __nccwpck_require__(357)
  , util = __nccwpck_require__(669)
  , Buffer = __nccwpck_require__(457).Buffer
  ;
